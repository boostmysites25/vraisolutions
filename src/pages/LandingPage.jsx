    ...
    <>
        ...
        <div className="pt-[13rem] pb-[5rem]">
          <div className="wrapper flex flex-col gap-7 justify-center h-full">
            ...
            <p data-aos="fade-up" className="text-white text-lg">
              {isWeb
                ? `We revolutionize digital experiences with cutting-edge web development 
              and AI-powered solutions. Our expert team crafts lightning-fast Progressive 
              Web Applications, intelligent e-commerce platforms, and scalable enterprise 
              solutions that drive 300% engagement increases and deliver measurable ROI. 
              From React 18 to AI integration, we transform your vision into digital excellence.
              `
      ...
      <section className="pt-[4rem]">
        <h2 data-aos="fade-up" className="wrapper section-heading text-center">
          How VR AI solutions helps you deliver the best results
        </h2>
        <div
          data-aos="fade-up"
        ...
        >
                     {[
             {
               ...
               desc: "We leverage cutting-edge artificial intelligence and machine learning to create intelligent solutions that adapt, learn, and evolve with your business needs, delivering unprecedented efficiency and competitive advantages.",
               styles: "bg-[#7C42DA] lg:rotate-[-18deg] lg:translate-y-[8rem]",
             },
             {
               title: "Revolutionary Web Development",
               desc: "Our expert team crafts lightning-fast Progressive Web Applications and scalable enterprise solutions using React 18, Next.js 14, and advanced technologies that drive 300% engagement increases.",
               styles: "bg-[#F8B000] lg:rotate-[-10deg] lg:translate-y-[3rem]",
             },
             {
               title: "Performance Excellence",
               desc: "We deliver websites that load in under 2 seconds, achieve 90+ PageSpeed scores, and implement advanced optimization techniques that ensure your digital presence outperforms competitors.",
               styles: "bg-[#B94391]",
             },
             {
               title: "Measurable Business Impact",
               desc: "Every solution we build delivers concrete ROI with 280% conversion increases, 65% bounce rate reductions, and comprehensive analytics that prove our value to your bottom line.",
               styles: "bg-[#D1B9F7] lg:rotate-[10deg] lg:translate-y-[3rem]",
             },
             {
               title: "Future-Ready Technology",
               desc: "We implement microservices architecture, real-time data processing, and cloud-native solutions that scale seamlessly with your business growth and adapt to emerging technologies.",
               styles:
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            <div className="flex flex-col md:w-8/12 lg:w-9/12">
              <div className="md:px-[2.5rem]">
                <p className="md:text-lg text-white font-semibold">
                  At VR AI solutions, we deliver excellence across web and app
          ...
          >
            <div className="flex flex-col md:w-8/12 lg:w-9/12">
              <div className="md:px-[2.5rem]">
                <p className="md:text-lg text-white font-semibold">
                  At VR AI solutions, we deliver tailored solutions across
